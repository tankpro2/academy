...
window.mockData = {
  // 1. 초기 사용자 계정 정보
  users: [
    { username: "유주", password: "1234", role: "director", is_password_changed: false, ref_id: null },
  ...
  notices: [
    ...
    { id: "nt-3", title: "7월 학원 휴일(정기 휴무일) 안내", content: "운영 가동 설정에 명시된 대로 7월 26일은 학원 전체 정기 휴일입니다. 등원 및 수업이 없으니 참고하십시오.", date: "2026-07-18", author: "원장" },
    { id: "nt-4", title: "고등부 수능 국어 평가원 분석 설명회 개최", content: "7월 28일 오후 7시, 학원 대강의실에서 고등부 학부모님을 대상으로 수능 모의평가 심층 분석 및 대책 설명회를 진행합니다.", date: "2026-07-20", author: "원장" },
    { id: "nt-5", title: "초등 독서 레벨 진단 평가 실시 안내", content: "신학기 대비 초등학생 전원 대상 레벨 진단 평가를 순차 진행하오니 지정 일정에 등원 바랍니다.", date: "2026-07-21", author: "원장" },
    { id: "nt-6", title: "중등부 기말고사 내신 대비 교재 배부", content: "중등부 학생들의 내신 고득점을 위한 학교별 맞춤 교재 작성이 완료되었으니 데스크에서 수령하시기 바랍니다.", date: "2026-07-21", author: "원장" },
    { id: "nt-7", title: "고3 수능 파이널 실전 봉투모의고사 개강", content: "수능 실전 감각 극대화를 위한 실전 모의고사반이 매주 토요일 오전 9시에 정식 개강합니다.", date: "2026-07-21", author: "원장" },
    { id: "nt-8", title: "우수 독후감 포상 및 시상식 안내", content: "6월 한 달 동안 훌륭한 독후감을 작성한 학생 5명에 대해 모바일 도서상품권을 증정합니다.", date: "2026-07-21", author: "원장" },
    { id: "nt-9", title: "강사 세미나로 인한 7월 29일 단축 운영 안내", content: "7월 29일(수)은 강사 연구 세미나 및 보수교육 관계로 오후 6시까지만 가동하오니 학부모님들의 양해 바랍니다.", date: "2026-07-21", author: "원장" },
    { id: "nt-10", title: "코로나 및 독감 예방을 위한 방역 협조 안내", content: "원내에서는 상시 환기 및 소독을 진행하고 있습니다. 등원 시 손 소독과 개인위생 관리에 동참해 주시길 부탁드립니다.", date: "2026-07-21", author: "원장" },
    { id: "nt-11", title: "초등저 어휘력 강화 워크북 무료 배포", content: "초등 1~4학년 대상 어휘 다지기 특별 워크북을 선착순 배포하오니 담당 선생님께 요청해 주세요.", date: "2026-07-21", author: "원장" },
    { id: "nt-12", title: "수강 및 시간표 변경 기간 안내", content: "8월 수강 일정 조율 기간은 7월 25일부터 30일까지입니다. 드롭다운을 통해 신청 부탁드립니다.", date: "2026-07-21", author: "원장" },
    { id: "nt-13", title: "학생 진로 진학 무료 1:1 컨설팅 선착순 모집", content: "원장이 직접 진행하는 진로진학 코칭 무료 세션을 선착순 10명 접수받습니다.", date: "2026-07-21", author: "원장" },
    { id: "nt-14", title: "EBS 수능 연계 문학 작품 핵심 정리집 배부", content: "고등부 수능대비 핵심 교재 배부가 완료되었습니다. 담당 선생님을 통해 수령하세요.", date: "2026-07-21", author: "원장" },
    { id: "nt-15", title: "중2 국어 문법 특강 개설 안내", content: "음운의 변동 및 품사 체계를 한 번에 정리하는 4주 완성 단기 속성 특강이 개설됩니다.", date: "2026-07-21", author: "원장" },
    { id: "nt-16", title: "독서 토론 동아리 \"책벌레들\" 3기 모집", content: "중학생 대상 자율 독서 토론 동아리 부원을 모집합니다. 주 1회 모임으로 학생부 기재에 유용합니다.", date: "2026-07-21", author: "원장" },
    { id: "nt-17", title: "수강 등록 3개월 미만 학생 집중 코칭 주간", content: "신규 등록 원생들의 학원 적응도와 독서 상태를 밀착 점검하는 코칭 기간을 운영합니다.", date: "2026-07-21", author: "원장" },
    { id: "nt-18", title: "학원 자습실 개방 시간 연장 안내 (방학 기간)", content: "방학 기간에 맞추어 평일 오전 10시부터 오후 10시까지 자습 공간을 상시 개방합니다.", date: "2026-07-21", author: "원장" },
    { id: "nt-19", title: "원내 도서 기증 캠페인 진행", content: "가정에서 다 읽은 양질의 초/중등 권장 도서를 학원에 기증해주시면 소정의 도서 교환권을 드립니다.", date: "2026-07-21", author: "원장" },
    { id: "nt-20", title: "2026학년도 대입 합격 수기집 배부 안내", content: "올해 대입에서 우수한 국어 성적으로 합격한 선배들의 노하우가 담긴 합격 수기집을 무료 배포합니다.", date: "2026-07-21", author: "원장" }
  ],
